...
<body>
  <nav >
    <label class="logo">Moonlighting</label>
  <ul>
    <li><a class="active" href="">Home</a></li>
    <li><a href="aboutus.html">About us</a></li>
    <li><a href="contact.html">Contact</a></li>
    <li><a href="feedback.html">Feedback</a></li>
    <img src="https://static.vecteezy.com/system/resources/previews/002/737/795/large_2x/online-registration-form-and-sign-in-button-concept-illustration-login-illustration-online-registration-illustrations-free-vector.jpg"  alt="" height="350" width="550">
  </ul>
  </nav>
